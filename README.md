...
- **`extentions`**: A set of custom Nunjucks extentions to add.
  The value of `extentions` should be a dictionary object where the keys are the filter names to use in the templates.
  The dictionary values define the filter functions, either as JavaScript function objects,
  or as the name of a Node module (as a string).
